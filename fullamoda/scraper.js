...
const url = "https://www.fullamoda.com/yeni-gelenler";
const baseURL = "https://www.fullamoda.com";
async function getProductsData(link, urls = []) {
  ...
  try {
    ...
    const { data: { products } } = await axios.get(`https://farktorapi.com/new/?company=Fr-5500142&category=${script}&page=${pageNum}&pageSize=60&sort=photoUpdate,desc&v=4053`)
    for (let i = 0; i < products.length; i++) {
      ...
      productsDetails.push({
        name: el.name,
        imageUrl: "https://images.farktorcdn.com/img/780x1170/Library/Upl/5500142/Product/" + el.photo,
        ...
        description: el.desc,
        images: el.photos.map(i => ("https://images.farktorcdn.com/img/780x1170/Library/Upl/5500142/Product/" + i.photo)),
