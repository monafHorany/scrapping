...
const url = "https://www.cottonhill.com.tr/en-trend-ic-camasiri-cok-satan-ic-giyim-cesitleri";
const baseURL = "https://www.cottonhill.com.tr";
...
async function getProduct(prodURL, link) {
  try {
    ...
    const product_source = "Cottonhill";
    const group_url = link;
    const propiteam = "";
    let images = [];
    let imageUrl = "";
    const brand = "Cottonhill";
    const name = cheerio(
