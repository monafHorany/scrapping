...
async function getProduct(prodURL, link) {
  try {
    ...
    // "body > div.application > main > section > div > div.product__primary > div > div > div.row.xl > div.col-xs-12.col-sm-5.col-md-5.product__detail-info > div > div.product__facet--variants > ul > li:nth-child(1) > ul"
